...
Revision ID: 722aac67fe68
Revises: 
Create Date: 2021-06-16 15:00:29.643330
...
def upgrade():
    ...
    sa.Column('from_station_name', sa.String(length=100), nullable=True),
    sa.Column('to_station_id', sa.Integer(), nullable=True),
    sa.Column('to_station_name', sa.String(length=100), nullable=True),
